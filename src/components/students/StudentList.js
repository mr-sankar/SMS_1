...
const StudentList = () => {
  ...
  return (
    <Container fluid className="py-4" style={{ minHeight: "100vh", backgroundColor: "#CAD2C5" }}>
      <Row className="mb-4 align-items-center animate__animated animate__fadeInDown">
        <Col xs={12} md={8}>
          <h1 className="fw-bold mb-0" style={{ fontSize: "2rem", color: "#2F3E46" }}>
            <i className="bi bi-mortarboard-fill me-2" style={{ color: "#52796F" }}></i>
            School Management Dashboard
          </h1>
          <small style={{ color: "#2F3E46" }}>Manage your student records efficiently</small>
        </Col>
        <Col xs={12} md={4} className="text-md-end mt-3 mt-md-0">
          ...
          >
            <i className="bi bi-person-plus-fill me-2" style={{ color: "#CAD2C5" }}></i>
            Add Student
          </Button>
        </Col>
      </Row>
      ...
      <Row className="mb-4 animate__animated animate__fadeInUp">
        <Col xs={12} md={6} lg={4}>
          <InputGroup className="shadow-sm">
            <InputGroup.Text style={{ backgroundColor: "#52796F", color: "#CAD2C5" }}>
      ...
      <Card
        className="shadow-lg border-0 animate__animated animate__zoomIn"
        style={{
          borderRadius: "15px",
          background: "linear-gradient(135deg, #354F52 0%, #84A98C 100%)",
        }}
      >
        <Card.Body className="p-4">
          {loading ? (
            <div className="text-center py-5">
              <Spinner animation="border" variant="primary" size="lg" style={{ color: "#52796F" }} />
              <p className="mt-3" style={{ color: "#2F3E46" }}>Loading student data...</p>
            </div>
          ) : (

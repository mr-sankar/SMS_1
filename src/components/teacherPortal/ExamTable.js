  ...
  return (
    ...
    >
      ...
      <div className="card shadow-sm p-3 Ke-sh">
        <h3 className="text-center mb-3 fw-bold Ke-bo " style={{
          color:"#0000ff"
        }}>Exam Management</h3>

        <div className="text-end mb-3">
          <button className="btn  btn-sm Ke-mod" onClick={handleOpenModal}
          style={{
            background: "#4C639B",
            color: "#fff",
            border: "none"
            ...
            <div className="table-responsive">
              ...
              >
                <thead
                  ...
                  style={{ backgroundColor: 'trasparent', color: 'rgb(7, 30, 131)', fontWeight: '600' }}
                >
                  <tr>
                    <th scope="col" style={{ width: '10%',backgroundColor: '#2D3A57',color:'white' }}>
                      Student ID
                    </th>
                    <th scope="col" style={{ width: '15%',backgroundColor: '#2D3A57',color:'white' }}>
                      Name
                    </th>
                    {selectedExam.subjects.map((subject, i) => (
                      <th key={i} scope="col" style={{ width: `${60 / selectedExam.subjects.length}%`,backgroundColor: '#2D3A57',color:'white' }}>
                        {subject}
                      </th>
                    ))}
                    <th scope="col" style={{ width: '10%',backgroundColor: '#2D3A57',color:'white' }}>

      ...
      <Card className='shadow-sm border-0 mb-4' style={{
        ...
        <Card.Header className=' border-bottom'>
          ...
          <Row className='align-items-center'>
            <Col xs={12} md={6}>
              <h3 className='mb-0 fs-5 fs-sm-4 fs-md-3'>Student Attendance</h3>
            </Col>
          </Row>
        </Card.Header>
          ...
          >
            <Row className='align-items-center'>
              <Col xs={12} md={6} className='mb-3 mb-md-0'>
                <h5 className='text-white fs-6 fs-sm-5 fs-md-4'>{student.name}</h5>
                <p className='text-primary mb-0 fs-6 fs-sm-5'>
                  <strong className='text-white'>Class:</strong> {student.class} |{' '}
                  <strong className='text-white'>Section:</strong> {student.section}
                </p>
                <p className='text-primary mb-0 fs-6 fs-sm-5'>
                  <strong className='text-white'>Admission No:</strong> {student.admissionNo} |{' '}
                  <strong className='text-white'> Roll:</strong> {student.rollNumber}
                </p>
              </Col>
          ...
          <Row className='mb-4 align-items-center'>
            <Col xs={12} sm={6} lg={7} className='mb-3 mb-sm-0'>
              <div className='d-flex flex-column flex-sm-row flex-wrap align-items-start align-items-sm-center'>
                <h5 className='mb-2 mb-sm-0 me-sm-3 fs-6 fs-sm-5 text-white'>

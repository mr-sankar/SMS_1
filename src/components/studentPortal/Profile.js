      ...
      >
          ...
          >
            ...
            <Box className="f-user-info">
              <Typography variant="h4" className="f-user-name text-primary">
                {studentData.name || "Student Name"}
              </Typography>
              <Typography variant="subtitle1" className="f-admission-no text-primary">
              ...
              <Card className="f-card">
                <CardContent>
                  <Box className="f-card-header">
                    ...
                    <Typography variant="h6" className="f-card-title text-primary">
                      Personal Information
                    </Typography>
                  </Box>

...
const Notification = () => {
  ...
  return (
    <div className="v-notification-container">
      <h2 style={{ color: "#0000ff" }}>📨 Principal Notification Dashboard</h2>
      ...
      <button className="btn btn-outline-primary btn-send" onClick={sendNotification} disabled={loading}>

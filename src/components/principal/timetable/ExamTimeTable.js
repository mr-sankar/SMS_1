          ...
          <div key={timetable._id} className="col-12">
            <div className="card shadow-sm animate__animated animate__fadeIn">
              <div className="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                ...
                <button  className="btn btn-outline-light btn-sm me-2 mt-1 " onClick={() => openTimetable(timetable._id)}>add</button>
                <button
                  className="btn btn-outline-light btn-sm shadow-sm mt-1"

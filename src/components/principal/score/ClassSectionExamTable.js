  ...
  return (
    <div className="container my-4" style={{
      ...
      style={{
        ...
        <h3 className="text-center mb-3 fw-bold" style={{ color: "#0000ff" }}>Class & Section Exam Results </h3>
        ...
        <div className="row mb-3 g-2">
          <div className="col-md-6">
            <label htmlFor="classSelect" className="form-label fw-semibold text-black">
              Select Class
            </label>
            <select
              id="classSelect"
          ...
          <div className="col-md-6">
            <label htmlFor="sectionSelect" className="form-label fw-semibold text-black">
              Select Section
            </label>
            <select
              id="sectionSelect"
        ...
        {selectedSection && (
          <div className="mb-3 text-center">
            <h5 className="fw-semibold text-secondary mb-2 text-white">Select an Exam</h5>
                ...
                exams.map((exam) => (
                  <button
                    ...
                    className={`btn btn-sm text-white ${
                      selectedExamId === exam._id ? "btn-success" : "btn-outline-white"
                    }`}

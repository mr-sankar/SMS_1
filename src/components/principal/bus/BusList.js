  ...
  return (
    ...
    >
      ...
      <div className="buslist-header-controls d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
        ...
        <button
          className="buslist-btn-success btn btn-primary btn-sm"
          onClick={() => {
            resetForm();
            setShowForm(true);
            scrollToForm();
        ...
        <tbody>
          {currentDrivers.map((driver, index) => (
            <tr key={driver._id}>
              ...
              <td style={tdStyle}>
              <button
  className="buslist-btn-edit btn btn-sm me-2 mt-2"
  style={{ backgroundColor: "#3e68e4", borderColor: "#99a8d6", color: "#fff" }}
...
<button
  className="buslist-btn-delete btn btn-sm mt-2"
  onClick={() => handleDelete(index)}
  style={{ backgroundColor: '#4c5264', borderColor: '#99a8d6', color: '#fff' }}
>
  Delete
</button>

...
const FeeManagement = () => {
  ...
  return (
    ...
    >
      <h2 className="text-center mb-4 fw-bold" style={{ color: "#0000ff" }}>Fee Structure Management</h2>
        ...
        >
          {loading ? (
            ...
            >
              ...
              >
                <tr>
                  <th style={{ backgroundColor: '#2D3A57',color:'white' }}>Class</th>
                  <th  style={{ backgroundColor: '#2D3A57',color:'white' }}>Tuition Fee (₹)</th>
                  <th  style={{ backgroundColor: '#2D3A57',color:'white' }}>Library Fee (₹)</th>
                  <th  style={{ backgroundColor: '#2D3A57',color:'white' }}>Transport Fee (₹)</th>
                  <th  style={{ backgroundColor: '#2D3A57',color:'white' }}>Total Amount (₹)</th>
                  <th  style={{ backgroundColor: '#2D3A57',color:'white' }}>Payable in 3 Terms (₹)</th>
                  <th  style={{ backgroundColor: '#2D3A57',color:'white' }}>Actions</th>
                </tr>
              </thead>
              <tbody>
                {fees.map((fee) => {

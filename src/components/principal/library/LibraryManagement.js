        ...
        {['books', 'borrowed', 'returned'].map((tab) => (
          <li className="nav-item" key={tab}>
            <button
              ...
              style={{
                backgroundColor: activeTab === tab ? '#6d85d0' : '#f8f9fa',
        ...
        <div className='animate__animated animate__fadeIn'>
          <div className='row mb-3'>
            <div className='col text-end'>
              <button className='btn btn-primary' onClick={fetchBorrowedBooks}>
                Refresh
              </button>
            </div>
          </div>
            ...
            <tbody>
              {paginateReturned.map((returnData) => (
                <tr key={returnData._id}>
                  ...
                  <td>{returnData.fineAmount !== undefined ? returnData.fineAmount : '0'}</td>
                  <td>{returnData.finePaid !== undefined ? (returnData.finePaid ? 'Yes' : 'No') : 'N/A'}</td>
                </tr>
              ))}
            </tbody>
          </table>

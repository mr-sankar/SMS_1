  ...
  return (
    <div className="container py-5">
      ...
      <div className="d-flex align-items-center mb-5 fade-in">
        <i className="bi bi-bus-front fs-2 me-3  bus-icon bounce" style={{color:"#0000ff"}}></i>
        <h1 className="mb-0 fw-bold " style={{color:"#0000ff"}}>Bus Route Details</h1>
      </div>
        ...
        <div className="row g-4">
          <div className="col-12 col-md-8 col-lg-6 mx-auto slide-in">
            <div className="card h-100 shadow-sm border-0 bus-card pulse">
              <div className="card-header  text-white " style={{background:"#5D79BE"}}>

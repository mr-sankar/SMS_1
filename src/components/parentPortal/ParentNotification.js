...
const ParentNotification = () => {
  ...
  const styles = {
    container: { padding: '30px', maxWidth: '900px', margin: '0 auto', fontFamily: "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif", background: 'transparent', minHeight: '100vh' },
    header: { color: '#0000ff', marginBottom: '25px', paddingBottom: '15px', borderBottom: '3px solid #3498db', textShadow: '1px 1px 2px rgba(0,0,0,0.1)', animation: 'slideInFromTop 0.5s ease-out' },
